...
# ============================================================
DATA_DIR = r"C:\Users\Aldair\Desktop\eventos_processados"
CHECKPOINT_PATH = r"vq_out\vqvae_ep019.pt"   # ajuste qual ep quer avaliar
...
try:
    from vqvae_train_new import VQVAE  # ajuste o nome do arquivo se for diferente
except Exception as e:
    logger.error("Falha ao importar VQVAE de vqvae_train_new: %s", e)
    VQVAE = None
