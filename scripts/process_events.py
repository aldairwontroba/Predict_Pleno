...
from src.segmentation.segmentation import SegParams, EventSegmenter
from src.segmentation.data_processing import process_day, find_files_for_pair
from src.segmentation.plotting import (
    print_event_stats,
    print_event,
...
if __name__ == "__main__":
    ...
    DATA_DIR  = PATHS.consolidados_npz
    DAY       = "20250912"
    PAIR      = ("wdo", "dol")   # ou 
    # PAIR      = ("win", "ind")   # ou 
    out_dir = PATHS.eventos_processados
